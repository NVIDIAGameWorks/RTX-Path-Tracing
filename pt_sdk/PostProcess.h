...
public:
    ...
    void Apply( nvrhi::ICommandList* commandList, RenderPassType passType, nvrhi::BufferHandle consts, nvrhi::BufferHandle miniConsts, nvrhi::IFramebuffer* targetFramebuffer, RenderTargets & renderTargets, nvrhi::ITexture* sourceTexture, bool pingActive );
    void Apply( nvrhi::ICommandList* commandList, ComputePassType passType, nvrhi::BufferHandle consts, nvrhi::BufferHandle miniConsts, nvrhi::BindingSetHandle bindingSet, nvrhi::BindingLayoutHandle bindingLayout, uint32_t width, uint32_t height, bool pingActive );
    void Apply( nvrhi::ICommandList* commandList, ComputePassType passType, int pass, nvrhi::BufferHandle consts, nvrhi::BufferHandle miniConsts, nvrhi::ITexture* workTexture, RenderTargets & renderTargets, nvrhi::ITexture* sourceTexture, bool pingActive );
};
